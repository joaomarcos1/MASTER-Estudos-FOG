...
public class GeradorGrafico {
    ...
    public void addValor(double vezes, String ordem, String palavra, double media) {
        dadoBarra.addValue(vezes, palavra, ordem);
        //dadoPizza.setValue(linha, media);
    }

    private void criaGrafico() {
        graficoBarra = ChartFactory.createBarChart("Valor atual", "Palavras", "Vesez", dadoBarra, PlotOrientation.VERTICAL, true, true, false);
